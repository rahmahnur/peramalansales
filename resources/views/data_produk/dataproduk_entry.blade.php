                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 offset-md-4">
                                        <form action="{{ url('/data_produk/store') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                     <i class="fa fa-id-badge fa-fw"aria-hidden="true"></i></span>
                                                    <input type="number" name="harga_produk"
                                                        class="form-control @error('harga_produk') is-invalid @enderror"
                                                        value="{{ old('harga_produk') }}" autofocus placeholder="harga_produk">
                                                    @error('harga_produk')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <text>ex : 23.000.000</text><br><br>
