...
<head>
  ...
  <title>Peramalan Tingkat Kinerja Sales</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('template/dist/img/LogoHonda.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Kartika Sari Putra</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('template/dist/img/ranuhi.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Rahmah Nur </a>
        </div>
      </div>
  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
          ...
          <!-- <li class="nav-item">
            <a href="/data_sales" class="nav-link">
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Honda Kartika Sari Putra Dinoyo</a>.</strong>
    All rights reserved.
...
<!-- ChartJS -->
<script src="{{asset('template/plugins/chart.js/Chart.min.j')}}s"></script>
